...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
who_is_running = 'M'; % 'M': Maria or Damian
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%model     = {'y ~ 1 + cat(VSNT_EX) + cat(faces) + NCRank + NCRank:VSNT_EX'};
...
% fixs_csv_file = '16subj_VSNTvsEX_for_unfold.csv'%'16subj_hardVSeasy_for_unfold.csv';
%e.g.: '(Intercept)' , 'hard_easy', 'stimulusDur', 'saccade_amp'
