...
switch strtrim(whoisrunning);
     ...
     case 'dac' | 'D' %'dac-Desktop'
        if isempty(laptop)
            dropbox_path            = '/media/dac/data/repos/visualsearch_eegem/codes';
            local_path              = '/media/dac/data/Experimentos/Analysis_2020';
            local_out               = '/media/dac/data/Experimentos/Analysis_2020'
            code_path.eeglabpath    = '~/Toolbox/eeglab14_1_2b';
        ...
        session_path.aux_data       = fullfile(local_out,'Analysis_aux_data/');
