...
folderPrepared      = fullfile(folderUnf, [datasetID, 'preparedEEG/'] );
...
eyemovs = fullfile(folderUnf, [datasetID, 'eyemovs/'] );
    if ~exist(eyemovs, 'dir'); mkdir(eyemovs); end

folderEyemovName     = [eyemovName '/'];

folderOut               = fullfile(eyemovs,folderEyemovName);
    if ~exist(folderOut, 'dir'); mkdir(folderOut); end
    fprintf('Output eye movements files: %s\n',folderOut)
...
%% 2nd STEP join all fix properties
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    fprintf('Rejecting data: subject %d: %.3f\n',iSuj, toc(tstart))
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    fprintf('Collecting fixations: subject %d: %.3f\n',iSuj, toc(tstart))
