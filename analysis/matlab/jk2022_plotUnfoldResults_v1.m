...
folderPrepared          = fullfile(folderUnf, 'preparedEEG/' );                     % jek 10/11/22: Partial output. I created this folder.
...
if freqFilteredEEG; folderOut   = fullfile(models,currentBand.name, '/',model2analyse);
else;               folderOut   = fullfile(models,model2analyse);
end
